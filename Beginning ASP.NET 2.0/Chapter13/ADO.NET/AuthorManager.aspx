...
<body>
    ...
    <asp:panel id="pnlSelect" style="Z-INDEX: 101; LEFT: 8px" runat="server" BackColor="#FFE0C0"
				...
				<P><BR>
					...
					<asp:Button id="cmdUpdate" runat="server" Text="Update" DESIGNTIMEDRAGDROP="51" onclick="cmdUpdate_Click"></asp:Button>&nbsp;
					<asp:Button id="cmdDelete" runat="server" Text="Delete" onclick="cmdDelete_Click"></asp:Button></P>
				<P>&nbsp;&nbsp;&nbsp;&nbsp;
