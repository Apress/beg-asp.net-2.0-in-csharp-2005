...
<body>
    ...
    <asp:label id="Label1" style="LEFT: 88px; POSITION: absolute; TOP: 51px" runat="server" >New Expression:</asp:label>
			<DIV style="BORDER-RIGHT: 2px groove; BORDER-TOP: 2px groove; Z-INDEX: 110; LEFT: 16px; BORDER-LEFT: 2px groove; WIDTH: 584px; BORDER-BOTTOM: 2px groove; POSITION: absolute; TOP: 120px; HEIGHT: 160px; BACKGROUND-COLOR: lightyellow" >
