...
<body>
    ...
    <div>
    <DIV style="BORDER-RIGHT: thin groove; BORDER-TOP: thin groove; FONT-SIZE: 80%; BORDER-LEFT: thin groove; WIDTH: 613px; BORDER-BOTTOM: thin groove; FONT-FAMILY: Verdana; HEIGHT: 272px; BACKGROUND-COLOR: lightyellow; padding-right: 10px; padding-left: 10px; padding-bottom: 10px; padding-top: 10px;"
				>
        <table style="width: 584px" >
            ...
            <tr>
				...
				<asp:CompareValidator id="vldRetype" 
					runat="server" ErrorMessage="Your password does not match." ControlToCompare="txtPassword" ControlToValidate="txtRetype" Width="224px"></asp:CompareValidator></td>
            </tr>
            <tr>
                <td style="width: 112px">
            ...
            <tr>
				...
				<asp:CustomValidator id="vldCode" runat="server"
					ErrorMessage="Try a string that starts with 014." ControlToValidate="txtCode" ClientValidationFunction="MyCustomValidation" OnServerValidate="vldCode_ServerValidate" Width="232px"></asp:CustomValidator></td>
            </tr>
        </table>
        <br />
				
				<asp:Button id="cmdSubmit" 
					runat="server" Width="120px" Text="Submit" OnClick="cmdSubmit_Click"></asp:Button>&nbsp;<asp:Button id="cmdCancel" 
					runat="server" Width="121px" Height="24px" Text="Cancel" CausesValidation="False" OnClick="cmdCancel_Click"></asp:Button></DIV>
        <br />
