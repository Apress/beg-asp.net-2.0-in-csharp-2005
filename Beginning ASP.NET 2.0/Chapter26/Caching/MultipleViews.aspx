...
<asp:checkboxlist id="chkColumns" runat="server" RepeatColumns="2"></asp:checkboxlist><br />
			<asp:button id="cmdApply"  runat="server" Width="112px" Text="Filter and Show" OnClick="cmdApply_Click"></asp:button><br />
        <asp:Label ID="lblCacheStatus" runat="server">Hide Columns:</asp:Label>
			<hr />
<asp:gridview id="gridPubs"  runat="server" Width="384px" Height="120px" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" BackColor="White" CellPadding="4" Font-Size="X-Small" Font-Names="Verdana" EnableViewState="False">
