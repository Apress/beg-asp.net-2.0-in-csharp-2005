...
<body>
    ...
    <div>
        <asp:CreateUserWizard ID="CreateUserWizard1" runat="server" BackColor="#EFF3FB" BorderColor="#B5C7DE"
            BorderStyle="Solid" BorderWidth="1px" Font-Names="Verdana" Font-Size="0.8em" DisableCreatedUser="True" Height="304px" Width="472px" DisplaySideBar="True" OnFinishButtonClick="CreateUserWizard1_FinishButtonClick" OnCreatedUser="CreateUserWizard1_CreatedUser">
            <WizardSteps>
                        ...
                        <tr>
                            <td style="padding-right: 15px; padding-left: 15px; padding-bottom: 5px; padding-top: 15px">
                                ...
                                <asp:CheckBoxList ID="chkSubscription" runat="server">
                                    ...
                                    <asp:ListItem>C# Planet</asp:ListItem>
